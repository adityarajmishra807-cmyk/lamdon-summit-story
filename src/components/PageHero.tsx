...
export function PageHero({
  ...
  return (
    <section className="surface-dark relative isolate flex min-h-[68vh] flex-col justify-end overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-[1600px] px-6 pb-16 pt-40 md:px-10 md:pb-24">
        ...
        {children ? <Reveal immediate delay={260}>{children}</Reveal> : null}
      </div>
    </section>
  );
}
